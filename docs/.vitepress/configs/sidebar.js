...
function getComsSidebar() {
  return [
    { text: 'MyAlert', link: '/my-alert/index' },
    { text: 'MyButton', link: '/my-button/index' },
    { text: 'MyCard', link: '/my-card/index' },
    { text: 'MyDialog', link: '/my-dialog/index' },
    { text: 'MyDatePicker', link: '/my-date-picker/index' },
    { text: 'MyMenu', link: '/my-menu/index' },
    { text: 'MyHeaderBreadcrumb', link: '/my-header-breadcrumb/index' },
    { text: 'MyMessage', link: '/my-message/index' },
    { text: 'MyMessageBox', link: '/my-message-box/index' },
    { text: 'MyNotification', link: '/my-notification/index' },
    { text: 'MyPageContainer', link: '/my-page-container/index' },
    { text: 'MyPagination', link: '/my-pagination/index' },
    { text: 'MyRadio', link: '/my-radio/index' },
    { text: 'MySelect', link: '/my-select/index' },
    { text: 'MySteps', link: '/my-steps/index' },
    { text: 'MySwitch', link: '/my-switch/index' },
    { text: 'MyTable', link: '/my-table/index' },
    { text: 'MyTabs', link: '/my-tabs/index' },
    { text: 'MyCheckbox', link: '/my-checkbox/index' },
    { text: 'MyLink', link: '/my-link/index' },
  ]
}
function getElement() {
  return [
