...
import MyDatePicker from './form/my-date-picker/index.vue'
...
import MyRadio from './form/my-radio/index.vue'
import MySelect from './my-select/index.vue'
import MySteps from './my-steps/index.vue'
import MySwitch from './form/my-switch/index.vue'
import MyTable from './my-table/index.vue'
import MyTabs from './my-tabs/index.vue'
import MyCheckbox from './form/my-checkbox/index.vue'
import MyLink from './base/my-link/index.vue'
